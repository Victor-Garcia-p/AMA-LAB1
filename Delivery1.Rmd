...
We use the Scott's formula to find the value of b = `scott` (this was done in the density estimation script used in class). The follwing is the histogram result:
